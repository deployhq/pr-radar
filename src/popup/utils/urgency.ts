...
> = {
  ci_failed: {
    label: 'CI failing',
    icon: '\u2717',
    colorClasses: 'bg-red-900/10 text-red-400 border-red-800/20',
    activeColorClasses: 'bg-red-900/25 text-red-300 border-red-500/50 ring-1 ring-red-500/15',
  },
  changes_requested: {
  ...
  review_requested: {
    ...
    icon: '\uD83D\uDC41',
    colorClasses: 'bg-amber-900/10 text-amber-400 border-amber-800/20',
    activeColorClasses: 'bg-amber-900/25 text-amber-300 border-amber-500/50 ring-1 ring-amber-500/15',
  },
  conflicts: {
    label: 'Conflicts',
    icon: '\u26A0',
  ...
  stale: {
    label: 'Stale',
    icon: '\uD83D\uDCA4',
    colorClasses: 'bg-gray-800/50 text-gray-400 border-gray-700/50',
    activeColorClasses: 'bg-gray-700/60 text-gray-300 border-gray-500/50 ring-1 ring-gray-500/15',
  },
};
