    ...
    <div className="px-4 py-4">
      ...
      <Section title="Display">
        ...
        <SettingRow
          ...
          description="Flag PRs with pending reviewers"
        >
          <select
            value={settings.longWaitDays}
            onChange={(e) => handleChange('longWaitDays', Number(e.target.value))}
            aria-label="Long wait threshold"
            className="bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-md px-2 py-1 text-xs text-gray-600 dark:text-gray-400"
          >
